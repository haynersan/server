...
{
    public class ExcluirUsuarioClaimCommand : BaseUsuarioClaimCommand, ICommandResult
    {

        public ExcluirUsuarioClaimCommand(Guid userId, string claimType, string claimValue)
        {
            UserId      = userId;
