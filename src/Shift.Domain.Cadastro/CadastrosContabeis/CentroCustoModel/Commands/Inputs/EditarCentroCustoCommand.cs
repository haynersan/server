...
{
    public class EditarCentroCustoCommand : BaseCentroCustoCommand, ICommandResult
    {

        public EditarCentroCustoCommand(string codEmpresa, long codCentroCusto, string nomeCentroCusto, string codGrupo, int codClasse, int codTipoBloqueio)
        {
        ...
        public void Validar()
        {
            ...
            AddNotifications(new Contract()
                ...
                .HasMinLen(NomeCentroCusto, 2, "Cod. Grupo", "O Cód. do Grupo deve possuir no mínimo 2 caracteres")
                .HasMaxLen(NomeCentroCusto, 3, "Cod. Grupo", "O Cód. do Grupo deve possuir no máximo 3 caracteres")
