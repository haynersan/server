...
namespace Shift.Infra.Data.Migrations
{
    ...
    [Migration("20180908184119_CentroCusto_NovaChavePrimaria_v3")]
    partial class CentroCusto_NovaChavePrimaria_v3
    {
            ...
            modelBuilder.Entity("Shift.Domain.Cadastro.CadastrosContabeis.CentroCustoModel.CentroCusto", b =>
                {
                    ...
                    b.Property<string>("EmpresasCodEmpresa");
            ...
            modelBuilder.Entity("Shift.Domain.Cadastro.CadastrosContabeis.CentroCustoModel.CentroCusto", b =>
                {
                    ...
                    b.HasOne("Shift.Domain.Cadastro.EmpresaModel.Empresa", "Empresas")
                        .WithMany("CentroCustos")
                        .HasForeignKey("EmpresasCodEmpresa");
                });
